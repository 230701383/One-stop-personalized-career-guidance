      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold">Career Advisor</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Your personalized career and education advisor, helping you discover the perfect path to your future success.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/scholarships" className="text-gray-300 hover:text-white transition-colors">
                  {t('nav.scholarships')}
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="text-gray-300 text-sm mt-2 md:mt-0">
            Made with ❤️ for your future success
          </p>
        </div>
      </div>
    </footer>
